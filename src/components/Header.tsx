  ...
  return (
    <header className="sticky top-0 z-50 backdrop-cinema border-b border-cinema-purple/20 shadow-md shadow-cinema-purple/10">
      <div className="container mx-auto px-4 lg:px-6 py-3 flex flex-col lg:flex-row items-center justify-between gap-4">
        ...
        <div className="flex-1 flex flex-col xl:flex-row items-center justify-center gap-4 w-full max-w-4xl">
          ...
          {/* Search */}
          <div className="flex-1 max-w-lg w-full xl:ml-8">
          ...
          {user ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-64 bg-card/95 backdrop-blur border-cinema-purple/30 shadow-xl shadow-cinema-purple/20 mt-2" align="end">
                ...
                <DropdownMenuItem onClick={handleLogout} className="px-4 py-3 hover:bg-destructive/10 text-destructive transition-colors">
        ...
        <div className="md:hidden mt-4 w-full px-2">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 pr-4 py-3 bg-secondary/50 border-cinema-purple/30 focus:border-cinema-gold focus:ring-2 focus:ring-cinema-gold/20 rounded-xl text-base w-full"
            />
          </div>
        </div>
      </div>
